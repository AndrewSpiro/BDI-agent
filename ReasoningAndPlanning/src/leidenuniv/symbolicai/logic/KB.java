...
public class KB {
    ...
    public void add(Sentence r) {
        // Adds a sentence to the KB, if it is not already present (the HashMap is just
        // there do to this fast, you coudl also look it up in the Vector rules).
        // Present means: Stringwise equal, i.e., if r unifies with KB without the need
        // for any substitution, it is not added again
    ...
    public KB union(KB kb1) {
        // Returns the union of this KB and kb1 as a new KB (containing refs(!) to the
        // sentences in the two originals).
        // Refs means that whatever you do to the result set will not affect kb1 or
        // rules, however, anything you do to the members of result
